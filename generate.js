...
function main() {
  ...
  var supply = prompt("How many images do you want to generate?", "8");

  var name = prompt("What is the name of your collection?", "player soccer card");

  var description = prompt("What is the description for your collection?", "player soccer card");
...
function toFolder(_name) {
  ...
  // Jian overwrote the following line in order to give it the correct path to generate photos
  var path = '/Users/jianwang/learning_hash_lip/hashlips_art_engine_ps_script-1.0.1'
