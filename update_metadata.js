...
function main () {
    ...
    var continueConfirmation = confirm(
      ...
      var prefix = prompt("What is your new metadata prefix?", "ipfs://QmaPcsMkjxVqLEXDcWsB7C7q38cP9maT22saAB6QVFHWDa");
      
      var suffix = prompt("What is you new metadata suffix?", ".png");
